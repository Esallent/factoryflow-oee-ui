export const translations = {
  ...
  downtime_categories_subtitle: "Manage all planned and unplanned downtime categories",
  downtime_type: "Downtime Type",
  downtime_type_description: "Select whether this is a planned or unplanned downtime",
  planned: "Planned",
  unplanned: "Unplanned",
  all_types: "All Types",
  not_applicable: "N/A",
  ...
  optional_remarks: "Optional notes or remarks",
  ...
  add_new_category: "Add New Category",
    ...
    configured_in_equipment: "Configured in equipment",
    ...
    // Lines & Equipment
    lines_subtitle: "Configure production lines, equipment, and downtime categories",
    lines_equipment: "Lines & Equipment Management",
    equipment: "Equipment",
    downtimes: "Downtimes",
    equipment_management_subtitle: "Configure equipment and assign planned downtimes",
    equipment_details: "Equipment Details",
    assigned_line: "Assigned Line",
    not_assigned_to_line: "Not assigned to any line yet",
    no_equipment: "No equipment configured. Add your first equipment to get started.",
    no_planned_downtimes_assigned: "No planned downtimes assigned to this equipment",
    assign_planned_downtimes: "Assign Planned Downtimes",
    select_planned_downtimes_description: "Select which planned downtimes apply to this equipment",
    absolute: "Absolute",
    per_cycle: "Per Cycle",
    cycle_time_description: "Minimum value: 0.1 minutes",
    planned_downtimes: "Planned Downtimes",
    line_configuration: "Line Configuration",
    line_configuration_subtitle: "Set up basic line information and associated equipment",
    line_name: "Line Name",
    line_code_placeholder: "e.g., LINE-001",
    add_line: "Add Line",
    add_equipment: "Add Equipment",
    line_name_placeholder: "e.g., Production Line A",
    ...
    line_active_description: "Enable or disable this production line",
    toggle_description: "Enable or disable this production line",
    save_line_config: "Save Line Configuration",
    save_line: "Save Line",
    line_saved_success: "Line configuration saved successfully",
    line_save_error: "Failed to save line configuration",
    error: "Error",
    shifts_subtitle: "Configure work shifts for this line",
    no_shifts: "No shifts configured. Add a shift to get started.",
  ...
  downtime_categories: "Categorías de paradas",
  downtime_categories_subtitle: "Gestionar todas las categorías de paradas planificadas y no planificadas",
  downtime_type: "Tipo de parada",
  downtime_type_description: "Seleccione si es una parada planificada o no planificada",
  planned: "Planificada",
  ...
  optional_remarks: "Notas u observaciones opcionales",
  ...
  add_new_category: "Agregar nueva categoría",
    ...
    configured_in_equipment: "Configuradas en el equipo",
    ...
    // Lines & Equipment
    lines_subtitle: "Configurar líneas de producción, equipos y categorías de paradas",
    lines_equipment: "Gestión de Líneas y Equipos",
    equipment: "Equipos",
    downtimes: "Paradas",
    equipment_management_subtitle: "Configurar equipos y asignar paradas planificadas",
    equipment_details: "Detalles del Equipo",
    assigned_line: "Línea Asignada",
    not_assigned_to_line: "No asignado a ninguna línea aún",
    no_equipment: "No hay equipos configurados. Agregue su primer equipo para comenzar.",
    no_planned_downtimes_assigned: "No hay paradas planificadas asignadas a este equipo",
    assign_planned_downtimes: "Asignar Paradas Planificadas",
    select_planned_downtimes_description: "Seleccione qué paradas planificadas aplican a este equipo",
    absolute: "Absoluto",
    per_cycle: "Por Ciclo",
    cycle_time_description: "Valor mínimo: 0.1 minutos",
    planned_downtimes: "Paradas Planificadas",
    line_configuration: "Configuración de Línea",
    line_configuration_subtitle: "Configure la información básica de la línea y el equipo asociado",
    line_name: "Nombre de Línea",
    line_code_placeholder: "ej., LINEA-001",
    add_line: "Agregar Línea",
    add_equipment: "Agregar Equipo",
    line_name_placeholder: "ej., Línea de Producción A",
    equipment_name: "Nombre de Equipo",
    active_equipment: "Equipo Activo",
    select_equipment_optional: "Seleccionar equipo (opcional)",
    active: "Activo",
    inactive: "Inactivo",
    active_status: "Estado activo",
    line_active_description: "Habilitar o deshabilitar esta línea de producción",
    toggle_description: "Activar o desactivar esta línea de producción",
    save_line_config: "Guardar configuración de línea",
    save_line: "Guardar Línea",
    line_saved_success: "Configuración de línea guardada exitosamente",
    line_save_error: "Error al guardar la configuración de línea",
    error: "Error",
    shifts_subtitle: "Configure los turnos de trabajo para esta línea",
    no_shifts: "No hay turnos configurados. Agregue un turno para comenzar.",
