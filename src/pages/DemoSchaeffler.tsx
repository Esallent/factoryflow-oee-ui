        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="space-y-2">
            ...
            <Select value={filters.line} onValueChange={(value) => setFilters({...filters, line: value})}>
              ...
              <SelectContent className="bg-card border-border z-50">
                <SelectItem value="Línea de Producción A">Línea de Producción A</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select value={filters.equipment} onValueChange={(value) => setFilters({...filters, equipment: value})}>
              ...
              <SelectContent className="bg-card border-border z-50">
                <SelectItem value="Torno CNC T-450">Torno CNC T-450</SelectItem>
              </SelectContent>
            </Select>
          </div>
